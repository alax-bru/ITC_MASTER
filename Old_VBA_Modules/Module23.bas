...
' MACRO PRINCIPALE
'===============================================================================
Public Sub PP_SOW_8002_ENG_Annexe_2()
...
Private Function TraiterLigne(ByVal r As Long) As Boolean
    ...
    ' Filtre strict : ENG et "Utilisé"
    If langue <> "ENG" Then Exit Function
...
Private Function EstUtiliseExact(ByVal t As String) As Boolean
    Dim n As String
    n = LCase(Trim(t))
    ' On normalise les accents pour éviter les faux négatifs
    n = Replace(n, "é", "e")
    n = Replace(n, "è", "e")
    n = Replace(n, "ê", "e")
    n = Replace(n, "ë", "e")
