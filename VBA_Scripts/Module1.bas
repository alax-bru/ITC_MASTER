...
Public Sub Generer_Livrable()
    ...
    ElseIf typeLivrable = "PP" Or typeLivrable = "SOW" Then
        ...
        ' Sauvegarde du Word généré dans Livrables_Générés avec versionning
        ...
        End If
        ' ⬇⬇⬇ TA DEMANDE : fermer le Word généré à la fin ⬇⬇⬇
...
' Génère un chemin avec suffixe _v1, _v2... si besoin
Private Function GetVersionedPath(ByVal folderPath As String, ByVal baseName As String, ByVal ext As String) As String
    ...
    ' Si le nom de base n'existe pas, on le prend tel quel
    If Dir(candidate) = "" Then
        GetVersionedPath = candidate
        Exit Function
    End If
    
    ' Sinon on ajoute _v1, _v2, etc.
    v = 1
    Do
        If Right$(folderPath, 1) = "\" Then
